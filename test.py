...
def compute_model_output(model, inputs):
    ...
    :return: Model outputs as a dictionary
    '''
    all_outputs = {}
...
def predict_song(args, audio_path, model):
    ...
    # Adjust predictions to match the original mix length
    for key in sources.keys():
        ...
        sources[key] = np.asfortranarray(sources[key])  # Ensures compatibility with librosa saving
